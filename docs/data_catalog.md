...
| birthdate | DATE | The date of birth of the customer, formated as YYY-MM-DD (eg. 1971-10-06). |
...
| product_id | INT | A unique identifier assigned to to the product for internal tracking and referencing. |
...
| Column Name | Data Type | Description |
| :--- | :--- | :--- |
| order_number | INT | A unique alphanumerical identifier for each sales order (e.g., 'SO54496). |
